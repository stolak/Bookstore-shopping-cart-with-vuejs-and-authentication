<template>
  <div style="z-index:99999999999">
    <button class="btn btn-primary navbar-btn" id="ShoppingCart" style="margin-top: -1px" data-toggle="modal" data-target="#shoppingCart">
      <i class="fa fa-shopping-cart" aria-hidden="true"></i>
      ( {{ numInCart }} )
    </button>
    <div id="shoppingCart" class="modal fade"  style="z-index:99999999999">
